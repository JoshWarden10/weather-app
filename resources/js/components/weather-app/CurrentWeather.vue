                ...
                <div class="w-full">
                    ...
                    <div class="flex items-center gap-8 mt-5">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-3xl font-medium text-gray-700">{{ currentCondition.label }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-3 gap-4">
                <div class="flex justify-center items-center flex-col gap-1">
                    ...
                    <p class="text-lg mt-1 font-semibold text-gray-800">{{ weather.current.relative_humidity_2m }}%</p>
                </div>

                <div class="flex justify-center items-center flex-col gap-1">
                    <p class="text-sm font-medium text-gray-500">Wind speed</p>
                    <p class="text-lg mt-1 font-semibold text-gray-800">{{ weather.current.wind_speed_10m }} {{ weather.current_units.wind_speed_10m }}</p>
                </div>

                <div class="flex justify-center items-center flex-col gap-1">
                    <p class="text-sm font-medium text-gray-500">Precipitation</p>
                    <p class="text-lg mt-1 font-semibold text-gray-800">{{ weather.current.precipitation }} {{ weather.current_units.precipitation }}</p>
                </div>
            </div>
        </div>
    </div>
